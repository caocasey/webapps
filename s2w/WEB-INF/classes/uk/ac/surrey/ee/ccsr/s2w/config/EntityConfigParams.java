...
public class EntityConfigParams extends ConfigParameters {
    ...
    public static final String ONTOLOGY_LOCAL_URL = "/share/ontologies/iot-a/original/VirtualEntityModel.owl";
    ...
    public static final String STM_1 = "/WEB-INF/prob_engine/iot-a/Entity/STM1.data";
    public static final String STM_2 = "/WEB-INF/prob_engine/iot-a/Entity/STM2.data";
    public static final String LDA_model = "/WEB-INF/prob_engine/iot-a/Entity/LDA_Model.data";
    public static final String unseen_concepts = "/WEB-INF/prob_engine/iot-a/Entity/unseen.data";
    public static final String index = "/WEB-INF/prob_engine/iot-a/Entity/index.db4o";
